...
export class SnakeAndLadderGameComponent {
  userInput !: number;
  playerCount: number = this.userInput;

  onButtonClick() {
    // Perform any action you want when the button is clicked
    if (this.userInput !== undefined && this.userInput !== null) {
      console.log('Input is valid. Performing action...');
      // You can perform additional actions here.
      this.playerCount = this.userInput;
      // Store the userInput value
      console.log('User Input:', this.userInput);
    } else {
      console.log('Input is invalid. Please enter a valid number.');
    }
  }
